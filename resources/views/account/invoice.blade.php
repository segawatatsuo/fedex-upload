        ...
        <div class="container mt-4">
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <span><a href="{{ route('account.index') }}">Account Services</a> / Invoice</span>
                </div>
            </div>
        </div>
                            ...
                            <div class="row ">
                                <div class="col-12 ">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-3 ">{{ $order->invoice_no  }}</div>
                                        <div class="col-2 "></div>
                                        <div class="col-2 "></div>
                                        <div class="col-2 text-right ">
                                            <a href="{{ asset('storage/pdf/'.$order->invoice_no.'.pdf') }}" download="{{ $order->invoice_no.'.pdf' }}">ダウンロード</a>
                                        </div>
                                    </div>
                                    <hr>
                                    @endforeach
