    ...
    <div class="container mt-4">
        ...
        <form action="{{ 'generate_quotation_pdf' }}" method="post">
            ...
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="text-right">
                                <button type="submit" class="btn btn-warning btn-lg">PRINTOUT</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>After the payment at JPY {{ number_format($amount_total) }} was confirmed, an order becomes
                    effective.</div>
                ...
                <table>
                    <tr>
                        <th>Bank</th>
                        <td> </td>
                        <td>{{ $preference_data->bank }}</td>
                    </tr>
                    <tr>
                        <th>Branch</th>
                        <td> </td>
                        <td>{{ $preference_data->branch }}</td>
                    </tr>
                    <tr>
                        <th>SWIFT Code</th>
                        <td> </td>
                        <td>{{ $preference_data->swift_code }}</td>
                    </tr>
                    <tr>
                        <th>Account #</th>
                        <td> </td>
                        <td>{{ $preference_data->swift_account }}</td>
                    </tr>
                    <tr>
                        <th>Name</th>
                        <td> </td>
                        <td>{{ $preference_data->swift_name }}</td>
                    </tr>
                </table>
