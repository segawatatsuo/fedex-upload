                ...
                @foreach ($premium_silks as $ps)
                    <div class="col-sm-15 col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6" style="text-align: right">{{ $ps->stock }}</div>
                        </div>
                        ...
                        <input type="text" readonly style="border-width:1px" type="text"
                            class="border-top-0 border-right-0 border-left-0" id="{{ $ps->product_code . '-PCS' }}"
                            value="" placeholder="">
                    </div>
                @endforeach
            </div>
            ...
            <div class="row">
                ...
                @foreach ($diamond_legs as $dl)
                    <div class="col-sm-15 col-6">
                        ...
                        <div class="row">
                            <div class="caption1 col-6">CARTON</div>
                            <div class="col-6" style="text-align: right">{{ $dl->stock }}</div>
                        </div>

                        
                        @if ($dl->stock == '0')
                            <input type="text" id="{{ $dl->product_code }}" class="txtCal outofstock"
                                name="item[{{ $dl->product_code . ' | ' . $dl->title_header . ' | ' . $dl->price }}]"
                                value="" placeholder="Out of stock" readonly>
                        @else
                        ...
                        <div class="caption1">PCS</div>
                        <input type="text" readonly style="border-width:1px" type="text"
                            class="border-top-0 border-right-0 border-left-0" id="{{ $dl->product_code . '-PCS' }}"
                            value="" placeholder="">
