                            ...
                            <td>
                                <div class="text-right pb-2">
                                    ...
                                    -->
                                        ...
                                        <button type="button" class="btn btn-danger btn-lg" style="width:230px" onClick="history.back()">backward</button>

                                    <button formaction="{{ 'order_complete' }}" type="submit"
                                        class="btn btn-warning btn-lg" style="width:230px">send</button>
